...
namespace SAA.Content.Base;

public abstract class BaseChestTile : ModTile
{
    public abstract int ItemType { get; }
    public virtual int KeyType => -1;
    public abstract void SetDust(ref int dustType);
    ...
    public override bool RightClick(int i, int j)
    {
        ...
        else
        {
            if (isLocked)
            {
                ...
                if (player.ConsumeItem(KeyType, includeVoidBag: true) && Chest.Unlock(left, top))
                {
